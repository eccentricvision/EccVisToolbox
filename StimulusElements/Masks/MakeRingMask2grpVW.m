function [MaskIm,mNew,nNew,GrpInd]=MakeRingMask2grpVW(m,n,RingRad,LineWidth,PixelJitter)
% function [MaskIm,mNew,nNew,GrpInd]=MakeRingMask2grpVW(m,n,RingRad,LineWidth,PixelJitter)
%
...
% J Greenwood 2014
%
% eg [mask,Xsize,Ysize,GrpInd]=MakeRingMask2grpVW(400,200,20,2,200/20); imshow(mask);
