function [MaskIm,mNew,nNew,GrpInd]=MakeNullOriMask2grp(m,n,LineLen,LineWid,CircWid,DotRad,PixelJitter)
% function [MaskIm,mNew,nNew,GrpInd]=MakeNullOriMask2grp(m,n,LineLen,LineWid,CircWid,DotRad,PixelJitter)
%
% make a mask stimulus of two groups of poke-ball stimuli, randomly assigned (but all same luminance) - to be coloured later in code, for instance
...
% J Greenwood 2012
%
% eg [mask,Xsize,Ysize,GrpInd]=MakeNullOriMask2grp(600,300,57,11,4,14,200/20); imshow(mask);
...
for tt=1:NumTemplate
    MaskWheel(:,:,tt) = MakeNullOrientDot(ElSize+6,LineLen,LineWid,CircWid,DotRad,0);%MakeCircleCross(PatchSize,TeeLen,TeeWid,CircWid,or1,or2)
