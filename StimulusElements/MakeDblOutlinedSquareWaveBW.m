function [imFinal,gratInd,inInd,outInd] = MakeDblOutlinedSquareWaveBW(patchsize,gratRad,theta,lambda,phase,numharmonics,con,lineWidIn,lineWidOut,circsquare)
...
% 
% eg  [imFinal,gratInd,inInd,outInd] = MakeDblOutlinedSquareWaveBW(256,80, pi/2, 160, deg2rad(0),5,1,10,10,1); ishow(imFinal);
% eg2 [imFinal,gratInd,inInd,outInd] = MakeDblOutlinedSquareWaveBW(256,80, deg2rad(80), 200, 0,5,1,10,10,2); ishow(imFinal);
% eg3 [imFinal,gratInd,inInd,outInd] = MakeDblOutlinedSquareWaveBW(256,66,deg2rad(80), 66*2, 0,5,1,14,12,1); ishow(imFinal); % -balanced feature sizes version
% J Greenwood 2013
