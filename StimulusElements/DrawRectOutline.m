function rectIm=DrawRectOutline(PatchX,PatchY,rdiamX,rdiamY,LineWid,angRange,offset)
...
%e.g.  rectIm = DrawRectOutline(300,300,100,100,10,[0 360],[0 0]); imshow(rectIm);
%e.g2. rectIm = DrawRectOutline(100,240,60,180,20,[90 270],[-15 0]); imshow(rectIm)
