...
% [screenWidthmm, screenHeightmm]=Screen('DisplaySize', screenNum);
...
if UseColour==1
    switch sp.WhereRU %1=Office, 2=Lab, 3=Laptop
        ...
        case 6 %new lab iMac with Display Plus Plus
            colCal='/Users/lab/Documents/MATLAB/EccVisToolbox/Calibration/MonitorData/CalDataDisplayPlusPlusRGB.mat'; %select Gamma calibration files
        case 9 %older lab iMac
