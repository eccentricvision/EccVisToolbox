...
thisFile='CalibrateOneMonitorSpatialAnglesBottom.m';
...
sp.BezelSize     = 2.5; %size of monitor bezel/edge in cm (2.2cm each with LED fixation due to gap, 2cm without)
...
sp.ZeroPosY       = 1020+sp.BezelPixels;%720;% 720];%[sp.ScreenResY-150 sp.ScreenResY-150];
...
if RightScreen
    AngVals         = [45 90 135];%5:5:175;%-75:5:75; % [0 25 155 180];%[-45:5:75 105:5:225]; %[-60:15:60 120:15:240];
else
    AngVals         = [45 90 135];%5:5:175;%105:5:255; % [0 25 155 180];%[-45:5:75 105:5:225]; %[-60:15:60 120:15:240];
end
