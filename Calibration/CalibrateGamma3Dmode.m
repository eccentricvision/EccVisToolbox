...
thisFile='CalibrateGamma3Dmode.m';
...
Use3Dmode = 0; %0/1 for 3D mode e.g. on Asus VG278
...
WhereRU  = 4;%DefInput('Where are you? 1=Lab 2=Office? 3=CinemaHD 4=Elsewhere',4);
if WhereRU==1
    fN = 'LabCalData.mat';
elseif WhereRU==2
...
defFname = 'C:\Users\JohnG\Desktop\CalDataAsusVG278left3Dmode.mat';%DefInput('Where to save calibration file? ',sprintf('%s%c',ThisDirectory,fN));
save(defFname,'LR')
